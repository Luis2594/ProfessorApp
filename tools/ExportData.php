...
abstract class ExportData {
    ...
    /*
     * Add a raw data to the current row
     */
    ...
    public function finalize() {
        ...
        //create a footer to ensure the integrity of our file
        $this->write($this->generateFooter());
        //according to the export type
        switch ($this->exportTo) {
            case 'browser':
                flush();
                break;
            case 'string':
                // do nothing, it's not needed xD
                break;
            case 'file':
    ...
    /**
     * Write input data into the output data
     * @param type $data data to be saved into the generated data to export
     */
